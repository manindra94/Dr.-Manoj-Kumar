export const MANOJ_KUMAR_PROFILE = {
  ...
  avatarUrl: "/assets/images/dr_manoj_kumar_1786374179949.jpg",
  stats: {
    yearsExperience: "15+",
...
export const MOCK_TECHNICAL_VERTICALS = [
  {
...
export const MOCK_BLOG_POSTS = [
  {
    ...
    comments: [
      {
        id: "c-1",
        userName: "Prof. S. Rao (IIT Bombay)",
        text: "Exceptional resolution on the EBSD misorientation plots. Did you observe significant sub-grain boundary dislocation density?",
        timestamp: "10:30 AM",
        date: "Mar 14, 2024"
      }
    ]
...
export const MOCK_CAREER_JOURNEY = [
  {
    period: "2025 — PRESENT",
...
export const MOCK_ACADEMIC_FOUNDATION = [
  {
    period: "2016 — 2021",
...
export const MOCK_TASK_REMINDERS = [
  {
    id: "task-01",
...
export const MOCK_TELEMETRY = [
  {
    ...
    event: "Backend REST API server initialized with complete scientometric collections",
    type: "sync",
    status: "success"
  },
  {
    ...
    event: "Security settings verified: AES-256 authenticated REST gateway active",
    type: "security",
    status: "success"
  },
  {
    ...
    event: "Realtime scientific telemetry channel linked",
    type: "system",
    status: "success"
  }
];
...
export const MOCK_MESSAGES = [
  {
    ...
    email: "a.vance@materials-cambridge.ac.uk",
    organization: "University of Cambridge",
    subject: "Joint Collaboration: High-Rate DED of Ti-Alloys",
    message: "Dear Dr. Kumar, We have read your recent publication in Surface & Coatings Tech on Inconel 718 laser alloying with great enthusiasm. We would like to explore collaborative beam-profiling testing with your team at CSIR-IMMT.",
    date: "2026-08-12",
  ...
  },
  {
    ...
    email: "spattnaik@iitbbs.ac.in",
    organization: "IIT Bhubaneswar",
    subject: "Invitation: Keynote on Additive Manufacturing 2026",
    message: "Requesting your availability for delivering the plenary keynote on metal 3D printing and microstructure characterization at the upcoming International Metallurgy Summit.",
    date: "2026-08-10",
